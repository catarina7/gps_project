			...
			<form action="noticeWrite" method="post" id="frm">
				<table>
					...
					<tr>
						...
						<td><input type="text" class="pro_in" name="n_writer" value="${member.m_name}" readonly="readonly" ></td>
					</tr>
					
					<tr>
						<td class="title">제목</td>
						<td><input type="text" class="pro_in" name="n_title" placeholder="제목을 입력하세요."></td>
					</tr>
