...
<body>
	...
	<section>
		...
		<h2 style="text-align: center;">※운영진에게 물어봐※</h2>
			<form action="qnaMod" method="post" id="frm" enctype="multipart/form-data">
				<table>
					<colgroup>
						<col style="width:20%;">
						<col style="width:80%;">
					...
					<tr>
						...
						<td><input type="text" class="pro_in" name="q_writer" value="${param.q_writer }" readonly="readonly" ></td>
					</tr>
					
					<tr>
						<td class="title">제목</td>
						<td><input type="text" class="pro_in" name="q_title" value="${param.q_title }"></td>
					</tr>
					...
					<tr>
						...
						<td>
							<div id="q_textarea">
								<textarea id="smarteditor" name="q_contents">${param.q_contents}</textarea>
							</div>
						</td>
					</tr>
